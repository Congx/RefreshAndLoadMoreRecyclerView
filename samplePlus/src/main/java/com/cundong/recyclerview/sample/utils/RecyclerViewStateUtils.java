...
//        }
     ...
     * @param errorListener FooterView处于Error状态时的点击事件
     */
    public static void setFooterViewState(Context instance, RecyclerView recyclerView, LoadingFooter.State state, View.OnClickListener errorListener) {
        setFooterViewState(instance,recyclerView,1,state,errorListener);
